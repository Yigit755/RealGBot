...
> **-bubble2** → bubble2 logo oluşturur. 
> **-dinamik** → dinamik logo oluşturur. 
> **-altın** → altın logo oluşturur. 
> **-banner** → banner logo oluşturur. 
> **-basit** → basit logo oluşturur. 
> **-elmas** → elmas logo oluşturur. 
> **-neonmavi** → neonmavi logo oluşturur. 
> **-kalın** → kalın logo oluşturur. 
> **-anime** → anime logo oluşturur. 
> **-habbo** → habbo logo oluşturur. 
> **-arrow** → arrow logo oluşturur. 
> **-green** → green logo oluşturur. 
> **-alev** → alev logo oluşturur. 
> **-red** → red logo oluşturur. 
> **-kalp** → kalp logo oluşturur. 
